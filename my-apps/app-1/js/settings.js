 ...
 * ===========
 * 
 * Replace PARTNER & CATEGORY (lines 19 and 20) with the values from the Veespo dashboard
 * You're good to go.
 */
...
vem = {
  ...
  config: {		
    ...
    partner:  'PARTNER',     // The organization id (get this from the Veespo dashboard)
    category: 'CATEGORY',    // The category id (get this from the Veespo dashboard)
    max_tags:  0,            // The maximum number of tags to display in the vote view (0 = no maximum)
  ...
  max_events: {
    summary: 1000,    // max number of refreshes to summary page (reset every time page is displayed)
    vote:    1000     // max number of refreshes to vote page (reset every time page is displayed)
  },
